...
export default function FWISection() {
  ...
  const imageUrl = `https://dataweb.bmkg.go.id/cuaca/spartan/23_kaltim_fwi_00.png?id=${Date.now()}`;
    ...
    <div className="bg-white text-center rounded-xl shadow-md p-3 flex flex-col h-full">
      ...
      <div className="bg-blue-50 text-gray-700 rounded-xl p-4 mt-4 border border-blue-100">
        <p className="text-sm sm:text-base leading-relaxed">
          <strong>FWI (Fire Weather Index)</strong> menunjukan besarnya intensitas api jika terjadi kebakaran hutan.
