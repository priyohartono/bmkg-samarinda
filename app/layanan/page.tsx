...
export default function PricingLayananPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FBFCFD] text-slate-900 font-sans py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((item) => (
            <div key={item.id} className="relative group h-full">
              ...
              {/* EFEK GLOW (Hanya muncul jika isPopular = true) */}
              {item.isPopular && (
                <>
                  <div className="absolute -inset-[2px] bg-gradient-to-b from-emerald-300 via-teal-400 to-blue-400 rounded-[34px] blur-md opacity-40 group-hover:opacity-0 transition-opacity duration-500" />
                  <div className="absolute -inset-[1px] bg-gradient-to-b from-emerald-100 to-transparent rounded-[34px] blur-xl opacity-50 group-hover:opacity-0 transition-opacity duration-500" />
                </>
              )}
              ...
              `}>
                ...
                {/* === PRICE SECTION (DENGAN GARIS ATAS & BAWAH) === */}
                {/* border-y = garis atas dan bawah */}
                {/* py-8 = padding atas dan bawah agar seimbang */}
                ...
                <div className="mb-8">
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    // === HOVER EFFECTS: TOMBOL JADI BIRU ===
        ...
        {/* ... (Grid Layanan di atas) ... */}

        {/* === BARU: SEKSI ALUR PENGAJUAN (HOW IT WORKS) === */}
        ...
        {/* === FOOTER REGULASI & HUKUM === */}
        <div className="border-t border-slate-200 pt-16">
          <div className="max-w-4xl mx-auto">
            
            {/* Box Keterangan Hukum */}
